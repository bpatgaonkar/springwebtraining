...
public class MyDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        //logger.debug("encodedPassword - "+passwordEncoder.encodePassword(presentedPassword, null));       
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        try {
            ...
            if(authentication.getCredentials() != null) {
                String presentedPassword = authentication.getCredentials().toString();
                logger.debug("presentedPassword - "+presentedPassword);
                logger.debug("userNotFoundEncodedPassword - "+userNotFoundEncodedPassword);
                passwordEncoder.isPasswordValid(userNotFoundEncodedPassword, presentedPassword, presentedPassword);
            }
            throw notFound;
